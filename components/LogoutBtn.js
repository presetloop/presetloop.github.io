...
function LogoutBtn() {
  ...
  return (
      ...
      <a
        className="block px-2 sm:px-2 pt-1 mt-[1.5px] mb-1.5 text-sm sm:text-md text-white sm:hover:text-white ease-in-out sm:hover:scale-110 sm:hover:transition-all duration-300"
        disabled={loggingOut}
        onClick={handleClick}
      >
